Rufus: The Reliable USB Formatting Utility for Windows
==========================================
...
The following steps outline the process for compiling the application:

1.  **Prerequisites:** Install Visual Studio Insiders (Community Edition) from [Microsoft](https://visualstudio.microsoft.com/insiders), ensuring the **Desktop Development with C++** workload is selected during installation.
2.  **Setup:** Download the project archive and extract its contents to your desktop.
3.  **Build:** Double-click the `rufus.sln` file to open the solution in Visual Studio.
4.  **Compile:** Build the project with the **Release x64** configuration.
5.  **Verification:** Check the build output for any compilation errors and resolve them as necessary.
...
* Download [UEFI Shell](https://github.com/pbatard/rufus/wiki/FAQ#What_languages_are_natively_supported_by_Rufus) ISOs
